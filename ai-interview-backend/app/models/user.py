...
class User(BaseModel):
    ...
    privacy_agreed_at = Column(TIMESTAMP(timezone=True), nullable=True)
    data_contribution_consent = Column(Boolean, nullable=False, default=False)
    data_contribution_consent_at = Column(TIMESTAMP(timezone=True), nullable=True)
    data_contribution_withdrawn_at = Column(TIMESTAMP(timezone=True), nullable=True)
    data_contribution_consent_version = Column(String(50), nullable=True)
