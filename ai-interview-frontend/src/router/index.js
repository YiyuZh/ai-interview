...
const routes = [
  ...
  { path: '/competition/opc-ai-workflow', name: 'CompetitionOpcAiWorkflow', component: () => import('../views/CompetitionOpcAiWorkflow.vue') },
  { path: '/competition/agent-trace', name: 'CompetitionAgentTrace', component: () => import('../views/CompetitionAgentTrace.vue') },
